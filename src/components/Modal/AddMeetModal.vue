<template>
  <div v-if="show"
    ...
    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700" style="min-width: 500px;">
      ...
      <div class="py-6 px-6 lg:px-8">
        ...
        <form @submit.prevent="onSubmit" class="space-y-6">
          <UserAutoComplete/>
<!--          <div>-->
<!--&lt;!&ndash;            <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Your&ndash;&gt;-->
