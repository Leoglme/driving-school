      ...
      <div class="py-6 px-6 lg:px-8">
        ...
        <Form @submit="onSubmit" class="space-y-6" :validation-schema="schema" v-slot="{ errors, meta }">
          ...
          <div>
            ...
            <UserAutoComplete v-if="event.extendedProps" :userId="event.extendedProps.chef" @setUser="setChef" id="chef"
                              :errors="errors.chef"/>
          </div>
          ...
          <div>
            ...
            <UserAutoComplete v-if="event.extendedProps" :userId="event.extendedProps.user" @setUser="setUser" id="user"
                              :errors="errors.user"/>
          </div>
          <div>
